...
# The base manifests/generic-bosh-deployment-taint-jobs.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/generic-bosh-deployment-taint-jobs.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
